      ...
      <div class="box box-info">
        ...
        <div class="box-body">
			...
			foreach($all as $row) {
				...
				if($row->ke=='3')
				{
					$btn_cetak = "<button class='btn btn-danger btn-xs btn-block' onclick='proses_lab($row->id_kunjungan)'>Proses</button>";

				}else{
					$btn_cetak = "<button class='btn btn-primary btn-xs btn-block' onclick='print_lab($row->id_kunjungan)'>Cetak</button>";
				}
...
function proses_lab(id_kunjungan)
{
	eksekusi_controller("index.php/lab/form/"+id_kunjungan);
}
