  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form id="form_tambah_relasi_gizi">
            <input type="hidden" name="id" id="id_relasi_gizi" class="form-control" readonly="readonly">           
            ...
            <div class="col-sm-8">
            	<input class="form-control" id="jabatan_gizi" name="jabatan_gizi">
            </div>
            <div style="clear: both;"></div><br>
...
$("#form_tambah_relasi_gizi").on("submit",function(){
	...
	if(id_pegawai=="" || id_spesialis=="")
	{
		...
		$.post("<?php echo base_url()?>index.php/relasi_gizi/simpan_form_relasi_gizi",ser,function(x){
			console.log(x);
			//$("#myModal").modal('hide');
			//eksekusi_controller("index.php/relasi_gizi/list_relasi_gizi");
			//$("#myModal").modal('hide');
...
function edit(id)
{
	$.get("<?php echo base_url()?>index.php/relasi_gizi/relasi_gizi_json/"+id,function(x){
		$("#id_relasi_gizi").val(x[0].id);
		$("#jabatan_gizi").val(x[0].jabatan_gizi);
...
function hapus(id)
{
	...
	{
		$.get("<?php echo base_url()?>index.php/relasi_gizi/hapus_relasi_gizi/"+id,function(x){
			eksekusi_controller('index.php/relasi_gizi/list_relasi_gizi');
		});
	}
}
