  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form id="form_tambah_relasi_staff">
            <input type="hidden" name="id" id="id_relasi_staff" class="form-control" readonly="readonly">           
            ...
            <div class="col-sm-8">
            	<input class="form-control" id="jabatan_staff" name="jabatan_staff">
            </div>
            <div style="clear: both;"></div><br>
...
$("#form_tambah_relasi_staff").on("submit",function(){
	...
	if(id_pegawai=="" || id_spesialis=="")
	{
		...
		$.post("<?php echo base_url()?>index.php/relasi_staff/simpan_form_relasi_staff",ser,function(x){
			console.log(x);
			//$("#myModal").modal('hide');
			//eksekusi_controller("index.php/relasi_staff/list_relasi_staff");
			//$("#myModal").modal('hide');
...
function edit(id)
{
	$.get("<?php echo base_url()?>index.php/relasi_staff/relasi_staff_json/"+id,function(x){
		$("#id_relasi_staff").val(x[0].id);
		$("#jabatan_staff").val(x[0].jabatan_staff);
...
function hapus(id)
{
	...
	{
		$.get("<?php echo base_url()?>index.php/relasi_staff/hapus_relasi_staff/"+id,function(x){
			eksekusi_controller('index.php/relasi_staff/list_relasi_staff');
		});
	}
}
