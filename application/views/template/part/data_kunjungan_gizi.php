        ...
        <div class="box-body">
			...
			foreach($all as $row) {
				...
				{					
					...
					$tr = "class='warning'";
					$btn_cetak = "<button class='btn btn-danger btn-xs btn-block' onclick='proses_gizi($row->id_kunjungan)'>Proses</button>";
					
					
				}else{
					
					$tr = "class=''";					
					$btn_cetak = "<button class='btn btn-primary btn-xs btn-block' onclick='print_gizi($row->id_kunjungan)'>Cetak</button>";					
...
function proses_gizi(id_kunjungan)
{
 	eksekusi_controller('index.php/master_gizi/proses_gizi/'+id_kunjungan);
}
