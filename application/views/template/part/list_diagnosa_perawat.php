    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form id="form_tambah_penyakit">
            ...
            <div class="col-sm-4">diagnosa perawat</div>
...
$("#form_tambah_penyakit").on("submit",function(){
	...
	$.post("<?php echo base_url()?>index.php/diagnosa_perawat/simpan",ser,function(x){
		console.log(x);
...
function edit(id)
{
	$.get("<?php echo base_url()?>index.php/diagnosa_perawat/json/"+id,function(x){
...
function hapus(id)
{
	...
	{
		$.get("<?php echo base_url()?>index.php/diagnosa_perawat/hapus/"+id,function(x){
			eksekusi_controller('index.php/diagnosa_perawat/all');
		});
	}
}
function tambah()
