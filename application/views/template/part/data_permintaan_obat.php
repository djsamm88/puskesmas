<section class="content-header">
      ...
      <div class="box box-info">
        ...
        <div class="box-body">
			...
			foreach($data_obat as $row) {
				...
				{
					$status='Kapus Setuju <br><span class="label label-success">Hubungi petugas farmasi Puskesmas</span></span>';
					$class = 'success';
 ...
 <script>
	...
	{
		$.get("<?php echo base_url()?>index.php/obat/detail_permintaan_obat/"+surat_permintaan,function(x){
