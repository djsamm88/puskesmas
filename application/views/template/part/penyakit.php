...
$("#form_tambah_penyakit").on("submit",function(){
	...
	$.post("<?php echo base_url()?>index.php/home/simpan_form_penyakit",ser,function(x){
		console.log(x);
...
function edit(id)
{
	$.get("<?php echo base_url()?>index.php/home/penyakit_json/"+id,function(x){
...
function hapus(id)
{
	...
	{
		$.get("<?php echo base_url()?>index.php/home/hapus_penyakit/"+id,function(x){
			eksekusi_controller('index.php/home/list_penyakit');
		});
	}
}
