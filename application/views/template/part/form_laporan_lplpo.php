    ...
    <section class="content">
      ...
      <div class="box box-info">
        ...
        <div class="box-body">
			...
			<form action ="<?php echo base_url()?>index.php/obat/xl_laporan_lplpo" method="get" id="form_obat_lap" target="blank">
			 <div class="row">
...
$("#form_obat_lap").on("submit",function(){
	...
	$.get("<?php echo base_url()?>index.php/obat/view_laporan_lplpo",ser,function(e){
		$("#t4_view").html("").html(e);
	})
	return false;
})
...
$("#download_pdf").on("click",function(){
	var ser = $("#form_obat_lap").serialize();
	var act = "<?php echo base_url()?>index.php/obat/pdf_laporan_lplpo";
