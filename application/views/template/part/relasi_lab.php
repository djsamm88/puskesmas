  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
          <form id="form_tambah_relasi_lab">
            <input type="hidden" name="id" id="id_relasi_lab" class="form-control" readonly="readonly">           
            ...
            <div class="col-sm-8">
            	<input class="form-control" id="jabatan_lab" name="jabatan_lab">
            </div>
            <div style="clear: both;"></div><br>
...
$("#form_tambah_relasi_lab").on("submit",function(){
	...
	if(id_pegawai=="" || id_spesialis=="")
	{
		...
		$.post("<?php echo base_url()?>index.php/home/simpan_form_relasi_lab",ser,function(x){
			console.log(x);
			//$("#myModal").modal('hide');
			//eksekusi_controller("index.php/home/list_relasi_lab");
			//$("#myModal").modal('hide');
...
function edit(id)
{
	$.get("<?php echo base_url()?>index.php/home/relasi_lab_json/"+id,function(x){
		$("#id_relasi_lab").val(x[0].id);
		$("#jabatan_lab").val(x[0].jabatan_lab);
...
function hapus(id)
{
	...
	{
		$.get("<?php echo base_url()?>index.php/home/hapus_relasi_lab/"+id,function(x){
			eksekusi_controller('index.php/home/list_relasi_lab');
		});
	}
}
