...
var nama_notif = "SILAHAP";



function notif_bawahan()
{
	$.get(url+"index.php/home/notif_bawahan",function(e){
		
		if(e != "0")
		{
				
			$("#t4_notif_bawahan").html(e);
			doNotification (nama_notif,e+" Permintaan Kinerja",1);
		}
	})
}
